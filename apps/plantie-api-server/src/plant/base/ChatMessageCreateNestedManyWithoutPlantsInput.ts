...
@InputType()
class ChatMessageCreateNestedManyWithoutPlantsInput {
...
export { ChatMessageCreateNestedManyWithoutPlantsInput as ChatMessageCreateNestedManyWithoutPlantsInput };
